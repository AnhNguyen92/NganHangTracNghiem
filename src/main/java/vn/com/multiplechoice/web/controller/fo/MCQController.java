...
public class MCQController {
	...
	private static final String REDIRECT_FO_USER_QUESTION = "redirect:/fo/user/questions";
	...
	@PostMapping("/one-ans")
	public String saveOneAnswerQuestion(Model model, final @ModelAttribute(MCQ_DTO) MCQDto mcqDto,
		...
		return REDIRECT_FO_USER_QUESTION;
	}
	...
	public String removeAnswerMultipleQuestion(Model model, MCQDto mcqDto, final BindingResult result,
	...
	public String saveMultipleAnswerQuestion(Model model, final @ModelAttribute(MCQ_DTO) MCQDto mcqDto,
			final BindingResult result) {
